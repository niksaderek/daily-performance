...
The leaderboard ranks buyers by profit while the funnel shows where calls are lost — just
over half of incoming calls connect, and about half of those convert.

![Top media buyers and the call conversion funnel](docs/buyers-and-funnel.png)

Affiliate traffic contributes roughly ten times the profit of internal buying here, but the
rate comparison is what informs a budget decision: affiliate leads on ROI, margin, and
conversion alike.

![Affiliate versus internal traffic](docs/segments.png)
...
with 90 days of synthetic history generated by
